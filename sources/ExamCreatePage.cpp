...
void ExamCreatePage::enterNumberOfQuestions(bool &numberOfQuestionsChosen)
{
    if (numberOfQuestionsChosen)
    {
    ...
    numberOfQuestionsChosen = true;
    this->numQuestions = numQuestions;
}

void ExamCreatePage::enterSemester()
{
...
void ExamCreatePage::enterTotalWeight()
{
...
void ExamCreatePage::edit()
{
    ...
    while (run)
    {
        ...
        {
            enterNumberOfQuestions(numQuestChosen);
        }
        else if (choice == "T")
        {
            enterTotalWeight();
